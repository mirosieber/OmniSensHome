 ...
 *
 * UART events UART_DATA reads serial buffer and send data to queue
 *uartRxStore_queue. uart_reception_task starts when uartRxStore_queue is
 *filled. It parses recieved frame data and send parsed data to system_queue for
 *further processing. uart_transmission_task starts when uartTx_queue is filled,
 *and send data to serial.
 *
 ******************************************************************************/
...
/**
 * @brief UART event task. Here UART RX callback takes place. This task should
 * be started in the main
 *
 * @param pvParameters
 */
...
/**
 * @brief UART TX function. The transmission starts once the related queue is
 * filled.
 *
 * @param pvParameters
 */
...
/**
 * @brief UART RX function. The reception starts once the related queue is
 * filled.
 *
 * @param pvParameters
 */
